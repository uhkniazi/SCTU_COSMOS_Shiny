# Name: cosmos_exploratory_analysis_tool.R
# Auth: u.niazi@soton.ac.uk; C.A.K.Roberts@soton.ac.uk
# Date: 24/04/2025
# Desc: analyse Level 1 translational datasets (expression set object)
#       with integrated clinical data
...
ui <- fluidPage(
  ...
  # Application title
  titlePanel("COSMOS Exploratory Analysis Tool"),
  
  # Sidebar with a panel for inputs
  sidebarLayout(
    sidebarPanel(
      # File input
      fileInput("obRDS", "1: Choose Expression Set Object RDS File",
                accept = c(
                  ".rds"
                )),
